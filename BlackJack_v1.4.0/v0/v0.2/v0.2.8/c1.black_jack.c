 ...
 *
 * PURPOSE:
 * 	Initializes a CardList by setting its head pointer to NULL and its len to 0, indicating an empty list.
 *
 * PARAMETERS:
 * 	cardlist: A pointer to the CardList to be initialized.
*/
 ...
 * 	
 * PURPOSE:
 * 	Fills a CardList with a standard 52-card deck.
 *
 * PARAMETERS:
 * 	deck: A pointer to the CardList to be filled.
*/
