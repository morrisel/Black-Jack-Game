...
void betting_phase(GameState *state __attribute__((unused))) 
{ 
} 
void initial_deal_phase(GameState *state __attribute__((unused))) 
{ 
} 
void blackjack_check_phase(GameState *state __attribute__((unused))) 
{ 
} 
void hit_or_stand_phase(GameState *state __attribute__((unused))) 
{ 
} 
void dealer_draw_phase(GameState *state __attribute__((unused))) 
{ 
} 
void reset_cards_phase(GameState *state __attribute__((unused))) 
{ 
} 
